...
class TriviaMazeGUI:
    ...
    def init_menubar(self):
        ...
        fileMenu.add_command(label="Save Current Game", command=self.save_current_game, font=("Arial", 10))
        fileMenu.add_command(label="Load Last Game", command=self.load_last_game, font=("Arial", 10))
